...
JSSpec.Logger.prototype.onRunnerStart = function() {
	...
	title.innerHTML = [
		...
		'	<li><span id="total_assertions">' + JSSpec.runner.totalExamples + '</span> assertions</li>',
...
JSSpec.Logger.prototype.onExampleEnd = function(example) {
	...
	document.getElementById("total_assertions").innerHTML = JSSpec.EqualityMatcher.should_be_counter;
...
JSSpec.EqualityMatcher.should_be_counter = 0;

JSSpec.EqualityMatcher.createInstance = function(expected, actual) {
    JSSpec.EqualityMatcher.should_be_counter++;
...
window.onload = function() {
    ...
    document.getElementById('specloadfailure').style.display = 'none'
}
